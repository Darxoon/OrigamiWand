...
TODO: verify that every field that is marked as a string is actually a string`),
	...
	[DataType.BtlUnit]: {
		...
		field_0xe4: "int",
		attack2: "string",
		attack3Description: "string",
		field_0xf8: "float",
		field_0xfc: "int",
		attack3: "string",
		attack4Description: "string",
		field_0x110: "float",
		field_0x114: "int",
		attack4: "string",
		attack5Description: "string",
		field_0x128: "float",
		field_0x12c: "int",
		attack5: "string",
		attack6Description: "string",
		field_0x140: "float",
		field_0x144: "int",
		attack6: "string",
		attack7Description: "string",
		field_0x158: "float",
		field_0x15c: "int",
		attack7: "string",
		attack8Description: "string",
		field_0x170: "float",
		field_0x174: "int",
		attack8: "string",
		attack9Description: "string",
		field_0x188: "float",
		field_0x18c: "int",
		attack9: "string",
		attack10Description: "string",
		field_0x1a0: "float",
		field_0x1a4: "int",
		attack10: "string",
		field_0x1b0: "int",
